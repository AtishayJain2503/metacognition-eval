...
class MATHLoader(BaseDatasetLoader):
    ...
    def _get_fixture_path(self) -> Path:
        if self.dataset_root and os.path.exists(os.path.join(self.dataset_root, "math_tasks.jsonl")):
            return Path(self.dataset_root) / "math_tasks.jsonl"
        fixtures_dir = Path(__file__).parent / "fixtures"
        return fixtures_dir / "math_tasks.jsonl"
